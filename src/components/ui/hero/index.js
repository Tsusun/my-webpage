...
export default function Hero() {
  ...
  return (
    <div
      className="hero flex flex-col my-48"
      style={{
        width: "100%",
        height: "100%"
      }}
      ...
      <div className=" bg-gray-50 bg-opacity-60 rounded p-6 sm:mx-5 dark:bg-gray-600 dark:bg-opacity-50">
        ...
        <div className="flex flex-col-3 items-center justify-center">
          <a className="px-2" href="https://github.com/Tsusun">
            <svg width="48" height="48" viewBox="0 0 512 512" className="inline">
              <path
                fill="black"
          ...
          <a className="px-1" href="https://twitter.com/jungler_v">
            <BsTwitter className="navbar-icon" color="black" />
          </a>
        ...
        <p className="animate-bounce p-2 text-white mt-6">↓</p>
    </div>
  )
}
