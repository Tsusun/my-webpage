...
export default function Footer() {
  const color = "white"
  return (
    <footer className="footer bg-gray-900" style={{ marginTop: "-3rem" }}>
      <div className="mx-auto flex flex-col items-center py-6 text-white">
        <p className="mb-6 mt-10 text-sm text-primary-2 font-bold">
          © {new Date().getFullYear()} Silvan Reigue
        </p>
        <div className="flex flex-col-3 items-center">
          ...
          <BsTwitter className="navbar-icon " />
          </a>
